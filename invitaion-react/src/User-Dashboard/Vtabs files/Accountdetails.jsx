...
import savelife from "../../User-Dashboard/assets copy/Frame 133542.svg"
import pfpavtar from "../../User-Dashboard/assets copy/Rectangle 7003.svg"
import pfpavtar2 from "../../User-Dashboard/assets copy/Rectangle 7004.svg"
  ...
  return (
    <div className="contenttxt">
      ...
      <div className="avtarset">
        ...
        <img src={pfpavtar} alt="" className="pfpavtar" onClick={() => handleAvatarClick('../../User-Dashboard/assets copy/Rectangle 7003.svg')} />
        <img src={pfpavtar2} alt="" className="pfpavtar2" onClick={() => handleAvatarClick('../../User-Dashboard/assets copy/Rectangle 7004.svg')} />
      </div>
      {selectedAvatar && (
